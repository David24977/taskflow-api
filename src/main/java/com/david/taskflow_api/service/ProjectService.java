...
public interface ProjectService {
    ...
    ProjectAdminResponseDto createProject(ProjectRequestDto projectRequestDto);
    ProjectAdminResponseDto updateProject(UUID id, UpdateProjectRequestDto updateProjectRequestDto);
    ProjectAdminResponseDto deleteProject(UUID id);
    ...
    List<ProjectAdminResponseDto> findProjectsByCurrentUser();
